...
import utils.diagnosis_utils as du
...
if __name__ == "__main__":
  ...
  # parser.add_argument('--bufferid', default='2BALL_EXAMPLE_EPS')
  parser.add_argument('--bufferid', default='EXAMPLE_EPS/310')

  parser.add_argument('--expid',    default='admc_sphero_distal/p2e/1')
  parser.add_argument('--ckpt',    default='variables_000901000.pkl')
  # parser.add_argument('--expid',    default='admc_sphero_novel_object_2ball/p2e/11')
  # parser.add_argument('--ckpt',    default='variables_000000100.pkl')
  parser.add_argument('--plot_intrinsic_reward', default='0')
  parser.add_argument('--burnin', default='60') #30
  parser.add_argument('--imagine_for', default='45') #45
  parser.add_argument('--which_ep', default=0)  #None
  parser.add_argument('--start_imagining_at', default=65) #65 #None
  parser.add_argument('--home', default=expanduser("~"))
  # parser.add_argument('--home', default='/home/saal2/Dropbox/_gendreamer/DATA/2ball')
  ...
  if 'GEN-EXAMPLE_EPS' in bufferid or '2BALL_EXAMPLE_EPS' in bufferid:
    which_eps = [[0], [1], [2], [3]]
    # which_eps = [[1], [3]]
  ...
  # home = expanduser("~")
  basedir = f"{home}/logdir/{expid}"
  buffer_basedir = f"{home}/logdir/{bufferid}"
  plot_lims=[-20,20]
  ...
  if do_visualize_dream:
    ...
    for batch_eps in which_eps:
      ...
      key_t = np.array([-60, -30, -20, -10, -3, 0, 3, 10, 20, 30])  #
