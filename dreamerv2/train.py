...
# gpu_indices = [1]  # For example, using GPUs 0 and 1
...
def main(logdir=None, config=None):
  ...
  should_rescan_priority = common.Every(float(config.rescan_priority_every))
  ...
  agnt.save(logdir / f'variables_init.pkl')
  print('saved variables_init.pkl')
  ...
  agnt.save(logdir / f'variables_{step.value:09}.pkl')
  agnt.save(logdir / 'variables.pkl')
  if should_prioritize(step):
    train_replay.save_priority(suffix=f'_{step.value:09}')
